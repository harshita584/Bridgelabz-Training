...
public class StringToLowerCase {
	...
	public static void main(String[] args) {
		...
		// calling the methods
	    String resultString = convertToLowerCase(string);
	    String builtString = string.toLowerCase();
	    // Displaying the result of both methods
	    System.out.println("The LowerCase String using custom method   : " + resultString);
	    System.out.println("The LowerCase String using built-in method : " + builtString);
	    
	    // Comparing the methods
	    System.out.println("\nComparing both the methods of converting string to lowercase: ");
